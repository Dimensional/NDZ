...
| 6 | never set by the reference packer, but **observed set** (alongside bit 4) in real ndz-studio output from its 2026-09-16-era "Pack hack" feature — see "xdelta-based hack container" below. Meaning fully reverse-engineered 2026-09-16; **implemented (read and write) in `Ndz.Core` the same day**, with CLI (`ndz pack-hack`) and GUI support added 2026-09-17 — see `docs/ndz-remaining-work.md`'s §4. |
