...
public class BlockSizeAnalyzerTests
{
    ...
    public void AnalyzePair_CombinedTotalIsTheSumOfBothSides_NotEitherAlone()
    {
        ...
        foreach (var candidate in result.Candidates)
        {
            ...
            long targetBest = candidate.TargetAnalysis.Curve.Single(p => p.DictionarySize == candidate.TargetAnalysis.RecommendedDictionarySize).EstimatedTotalSize;
        ...
        Assert.Equal(recommended.TargetAnalysis.RecommendedDictionarySize, result.RecommendedTargetDictionarySize);
    }
